...
class ModifyLongValueComponent extends StatefulWidget {
  final String installationId;
  final String nodeId;
  final Metric metric;
  final MetricValue value;

  const ModifyLongValueComponent({
  ...
  @override
  State<StatefulWidget> createState() => _ModifyLongValueComponentState();
}

class _ModifyLongValueComponentState
    extends State<ModifyLongValueComponent> with ModifyMetricValueMixin{
